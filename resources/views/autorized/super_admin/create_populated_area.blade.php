...
<html>
<head>
    <title>Создать Населённый Пункт</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="banner">
                    <h1>Создать Населённый Пункт</h1>
                    <p>Введите информацию о новом населённом пункте ниже.</p>
                </div>
                ...
                <div class="main-content mt-4">
                    ...
                    <form action="{{ route('store_populated_area') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="name">Название населённого пункта:</label>
                        ...
                        <button type="submit" class="btn btn-primary">Создать Населённый Пункт</button>
                    </form>
                </div>
            </div>
        </div>
